        ...
        <main>
            ...
            <section className="bg-brand-dark py-16 md:py-20 relative overflow-hidden">
                ...
                <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-4">About Al-Iqra</h1>
                    <p className="text-gray-300 max-w-xl mx-auto text-lg">
                        A Beautiful Blend of Knowledge, Character, and Modern Development — established 2018.
                    </p>
                </div>
